...
import {ForgotPasswordControllerClient} from "@/app/api/public/user/forgot-password/controller/forgot-password-controller-client";
        ...
        <div className={"border-2 border-darkGreen p-4 rounded-xl w-full max-w-md md:max-w-lg bg-gray-900/70 flex flex-col gap-4"}>
            ...
            {!submitted ? (
                ...
                <>
                    ...
                    <Link href="/public" className={"text-lightGreen text-center border-2 border-darkGreen p-2 rounded-md"}>
