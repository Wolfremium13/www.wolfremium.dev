...
import profilePic from "@/public/layout/personal-image.webp";
    ...
    <Card>
      <section className="flex flex-col xl:flex-row items-center justify-center gap-8 p-8">
        <div className="w-full xl:w-1/2 max-w-xl">
          <Image src={profilePic} alt="Kevin Hierro" className="rounded-full border-4 border-darkGreen" />
        </div>
        <div className="w-full xl:w-1/2 text-center xl:text-left">
          ...
          <p className="text-lg mb-4">
            Soy un apasionado desarrollador de software con una amplia
            experiencia en la creación de aplicaciones web y móviles. Mi amor
            por la tecnología y la programación me ha llevado a adquirir
            habilidades en una variedad de lenguajes y tecnologías, incluyendo
            Python, TypeScript, Java, React y React Native.
          </p>
          <p className="text-lg mb-4">
            A lo largo de mi carrera, he tenido la oportunidad de trabajar con
            Firebase y AWS, lo que me ha permitido desarrollar soluciones
            ...
            aprendizaje automático, áreas en las que estoy ansioso por
            profundizar y expandir mis conocimientos.
          </p>
          <p className="text-lg mb-4">
