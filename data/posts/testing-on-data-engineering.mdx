...
deseado `str`, que no pueda ser null, o que cumpla con la regex. Es un nivel
básico pero da un soporte de seguridad antes de almacenar cualquier cosa
incorrecta, siempre puedes equivocarte en una transformación.
...
vista, puede ser un test de e2e caja negra dondé esperamos un resultado
...
debería de existir otra columna que hace referencia en a la key en el otro. Esto
me parece super útil a la hora de hacer transformaciones de datos, ya qué nos
