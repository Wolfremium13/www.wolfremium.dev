...
Se desarrolló el kata propuesto por Mireia [Range Parser](https://github.com/lean-mind/katas-formacion/tree/main/rangeParser), en el leguaje de Clojure. Una experiencia agridulce en la qué se aprende formas más fáciles de trabajar datos.
