...
Voy a hacerlo desde el principio como si tuviesemos el ubuntu nuevo sin nada,
...
> Una vez instalado nos pregutará si queremos zsh como terminal prederminada le
> damos a sí, pero recuerda que para que el cambio surta efecto deberemos hacer
> un logout e iniciar otra vez. Aqunque siempre podemos usar `exec zsh` dentro
> de bash.
...
desbloquear los perfiles de colores en las prefencias de tu terminal.
...
he tenido que repetir comando especifícos.
